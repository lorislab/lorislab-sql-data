...
public class SimpleMapperImpl implements SimpleMapper {
    ...
    public static final SimpleMapperImpl INSTANCE = new SimpleMapperImpl();

    @Override
    public org.lorislab.quarkus.data.test.source.Model map1(io.vertx.mutiny.sqlclient.Row row) {
        if (row == null) {
            return null;
        }
    ...
    public static org.lorislab.quarkus.data.test.source.Model map1S(io.vertx.mutiny.sqlclient.Row row) {
        return INSTANCE.map1(row);
    }

    @Override
    public org.lorislab.quarkus.data.test.source.Model mapSqlMapping3(io.vertx.mutiny.sqlclient.Row row) {
        if (row == null) {
            return null;
        }
        ...
        java.lang.String id = null;
        if ((idx = row.getColumnIndex("uid")) != -1 && (id = row.getString(idx)) != null) {
            result.id = id;
        }
        if (id == null) {
            return null;
        ...
        java.lang.String parent;
        if ((idx = row.getColumnIndex("p")) != -1 && (parent = row.getString(idx)) != null) {
            result.parent = parent;
        }
    ...
    public static org.lorislab.quarkus.data.test.source.Model mapSqlMapping3S(io.vertx.mutiny.sqlclient.Row row) {
        return INSTANCE.mapSqlMapping3(row);
    }

    @Override
    public org.lorislab.quarkus.data.test.source.Model mapSqlMapping4(io.vertx.mutiny.sqlclient.Row row) {
        if (row == null) {
            return null;
        }
        ...
        java.lang.String statusInteger;
        if ((idx = row.getColumnIndex(org.lorislab.quarkus.data.test.source.Model_.STATUS_INTEGER)) != -1
                && (statusInteger = row.getString(idx)) != null) {
            result.statusInteger = org.lorislab.quarkus.data.test.source.ModelStatus.valueOf(statusInteger);
        }
    ...
    public static org.lorislab.quarkus.data.test.source.Model mapSqlMapping4S(io.vertx.mutiny.sqlclient.Row row) {
        return INSTANCE.mapSqlMapping4(row);
    }
